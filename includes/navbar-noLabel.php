		...
		<div class="collapse navbar-collapse" id="nvbCollapse">
			<ul class="navbar-nav ml-auto mx-auto">
				<li class="nav-item pl-1">
					<a class="nav-link" href="index.php#home"><i class="fa fa-home fa-fw mr-1"></i>HOME</a>
				</li>
				<li class="nav-item pl-1">
					<a class="nav-link" href="index.php#feedback"><i class="fa fa-info-circle fa-fw mr-1"></i>ABOUT US</a>
				</li>
				<li class="nav-item pl-1">
					<a class="nav-link" href="index.php#services"><i class="fa fa-th-list fa-fw mr-1"></i>SERVICES</a>
				</li>
				<!--<li class="nav-item pl-1">
